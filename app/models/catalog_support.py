...
class Source(Base):
    ...
    adapter_key = Column(String(255), nullable=True)
    parser_config = Column(JSONB, nullable=False, default=dict, server_default=sa_text("'{}'::jsonb"))
...
class PricingSetting(Base):
    ...
    eur_to_usd_rate = Column(Numeric(12, 6), nullable=False)
    gbp_to_usd_rate = Column(Numeric(12, 6), nullable=False)
    jpy_to_usd_rate = Column(Numeric(12, 8), nullable=False)
